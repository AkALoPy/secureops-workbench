...
This repo is intended for portfolio and learning use. Do not commit secrets, CloudTrail exports, or local evidence folders.
...
This repo does not ship with CloudTrail exports checked in.
